...
-(BOOL)notMove
{
    return [objc_getAssociatedObject(self, "notMove") boolValue];
}
-(void)setNotMove:(BOOL )notMove
{
    self.longPress.enabled = !notMove;
    objc_setAssociatedObject(self, "notMove", @(notMove), OBJC_ASSOCIATION_RETAIN_NONATOMIC);
