...
@class XWDragCellCollectionView , HQRootModel;
 ...
 *  cell移动完毕
 */
- (void)dragCellCollectionViewCellEndMoving:(XWDragCellCollectionView *)collectionView cellMoveAtIndexPath:(NSIndexPath *)indexPath;
/**
 *  成功交换了位置的时候调用
