...
- (void)setUpCollectionView {
  ...
  UICollectionViewFlowLayout *collectLayout = (UICollectionViewFlowLayout *)photoGridView.collectionViewLayout;
    collectLayout.sectionInset = UIEdgeInsetsMake(10, 10, 10, 10);
    collectLayout.minimumLineSpacing = 10;
    
  HQLog(@"translucent %@",[UINavigationBar appearance].translucent?@"yes":@"no");
...
//    return CGSizeMake(80, 80);
    return CGSizeMake((SCREEN_WIDTH - 50)/4.0, (SCREEN_WIDTH - 50)/4.0);
}
