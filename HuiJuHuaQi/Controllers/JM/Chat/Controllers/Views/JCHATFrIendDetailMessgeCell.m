...
- (void)awakeFromNib {
  ...
  [self.skipBtn setBackgroundImage:[ViewUtil colorImage:HexAColor(0x6fd66b,1) frame:_skipBtn.frame] forState:UIControlStateNormal];
  [self.skipBtn setBackgroundImage:[ViewUtil colorImage:HexAColor(0x50cb50,1) frame:_skipBtn.frame] forState:UIControlStateHighlighted];
}
