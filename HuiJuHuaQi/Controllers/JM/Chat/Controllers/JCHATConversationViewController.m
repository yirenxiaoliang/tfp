...
- (void)viewDidLayoutSubviews {
  HQLog(@"Event - viewDidLayoutSubviews");
...
- (void)addtoolbar {
  self.toolBarContainer.toolbar.frame = CGRectMake(0, 0, SCREEN_WIDTH, 49);
...
- (void)setupComponentView {
  ...
  [self.view addGestureRecognizer:gesture];
    ...
    _toolBarHeightConstrait.constant = 49;
...
//      HQLog(@"Logout callback with - %@", error);
//    }];
//    
