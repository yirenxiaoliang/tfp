...
static NSString * const FORMAT_PAST_TIME = @"HH:mm";
static NSString * const FORMAT_THIS_WEEK = @"eeee HH:mm";
static NSString * const FORMAT_THIS_WEEK_SHORT = @"eeee";
static NSString * const FORMAT_YESTERDAY = @"HH:mm";
static NSString * const FORMAT_TODAY = @"HH:mm";
...
周二 08:21 （今天昨天之前的本周显示星期）
 
11/18 11:58 （一周之前且今年内显示具体的日期）

2015/01/22 11:58 （今年之前显示具体的日期）
*/
...
//        output = [NSString stringWithFormat:@"%@ %@", thePastDate, output];
          output = [HQHelper nsdateToTimeNowYear:[theDate timeIntervalSince1970]*1000];
