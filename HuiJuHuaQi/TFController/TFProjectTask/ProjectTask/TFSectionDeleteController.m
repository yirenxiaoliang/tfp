...
@interface TFSectionDeleteController ()<UITableViewDelegate,UITableViewDataSource,HQBLDelegate>
/** tableView */
...
@implementation TFSectionDeleteController
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    ...
    if (buttonIndex == 1) {
        ...
        if ([str isEqualToString:self.selectRow.name]) {
            ...
            [self.projectTaskBL requestDeleteProjectSectionWithSectionId:self.selectRow.id columnId:self.projectColumnModel.id projectId:self.projectId];
        }else{
