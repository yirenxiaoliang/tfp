...
@interface TFTaskMainController ()<YPTabBarDelegate>

@end

@implementation TFTaskMainController
...
//    TFTaskListController *controller1 = [[TFTaskListController alloc] init];
    TFNewTaskListController *controller1 = [[TFNewTaskListController alloc] init];
    controller1.type = 0;
    controller1.yp_tabItemTitle = @"全部";
    
//    TFTaskListController *controller2 = [[TFTaskListController alloc] init];
    TFNewTaskListController *controller2 = [[TFNewTaskListController alloc] init];
    controller2.type = 1;
    controller2.yp_tabItemTitle = @"我负责";
    
//    TFTaskListController *controller3 = [[TFTaskListController alloc] init];
    TFNewTaskListController *controller3 = [[TFNewTaskListController alloc] init];
    controller3.type = 2;
    controller3.yp_tabItemTitle = @"我参与";
    
//    TFTaskListController *controller4 = [[TFTaskListController alloc] init];
    TFNewTaskListController *controller4 = [[TFNewTaskListController alloc] init];
    controller4.type = 3;
    controller4.yp_tabItemTitle = @"我创建";
    
//    TFTaskListController *controller5 = [[TFTaskListController alloc] init];
//    controller5.type = 4;
//    controller5.yp_tabItemTitle = @"进行中";
    
//    TFTaskListController *controller6 = [[TFTaskListController alloc] init];
    TFNewTaskListController *controller6 = [[TFNewTaskListController alloc] init];
    controller6.type = 5;
    controller6.yp_tabItemTitle = @"已完成";
    
    self.viewControllers = [NSMutableArray arrayWithObjects:controller1, controller2, controller3, controller4, controller6, nil];
}
