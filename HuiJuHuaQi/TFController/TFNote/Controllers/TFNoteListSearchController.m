...
@interface TFNoteListSearchController ()<HQTFSearchHeaderDelegate,UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,HQBLDelegate,TFSliderCellDelegate>
...
@implementation TFNoteListSearchController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    TFNoteDataListModel *model = _allRecords[indexPath.row];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    UILabel *lab1 = [UILabel initCustom:CGRectZero title:@"备忘录" titleColor:WhiteColor titleFont:14 bgColor:ClearColor];
    ...
    NSString *str = [NSString stringWithFormat:@"已找到%ld项",_allRecords.count];
    UILabel *lab2 = [UILabel initCustom:CGRectZero title:str titleColor:WhiteColor titleFont:10 bgColor:ClearColor];
...
-(BOOL)textFieldShouldReturn:(UITextField *)textField{
    ...
    [self.noteBL requestGetNoteListWithPageNum:1 pageSize:20 type:0 keyword:self.keyWord];
...
-(void)finishedHandle:(HQBaseBL *)blEntity response:(HQResponseEntity *)resp{
    ...
    if (resp.cmdId == HQCMD_getNoteList) {
        ...
        _allRecords = self.mainModel.dataList;
