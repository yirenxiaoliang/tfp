...
@property (nonatomic, strong) UIImageView * dot;// 点
...
- (void)customView
{
    ...
    [self.baseView addSubview:self.dot];
    ...
    [self.dot mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(self.baseView).offset(-4);
...
//        make.top.equalTo(self.icon.mas_bottom).with.offset(2);
        make.bottom.equalTo(self.icon).with.offset(7);
