...
- (void)scrollViewContentOffsetDidChange:(NSDictionary *)change
{
    ...
    if (self.state == MJRefreshStateNoMoreData || self.state == MJRefreshStateSelfNoMoreData) {
...
- (void)setState:(MJRefreshState)state
{
    ...
    // 根据状态来设置属性
    if (state == MJRefreshStateSelfNoMoreData || state == MJRefreshStateNoMoreData || state == MJRefreshStateIdle) {
        // 刷新完毕
